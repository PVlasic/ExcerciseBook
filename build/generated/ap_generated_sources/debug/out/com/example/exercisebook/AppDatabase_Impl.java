...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        ...
        _db.execSQL("CREATE TABLE IF NOT EXISTS `ExerciseDay` (`Id` INTEGER PRIMARY KEY AUTOINCREMENT, `userId` INTEGER)");
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'dab6a129d0f7da797c5e0c8ff43ee81d')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        final HashMap<String, TableInfo.Column> _columnsExerciseDay = new HashMap<String, TableInfo.Column>(2);
    ...
    }, "dab6a129d0f7da797c5e0c8ff43ee81d", "1a658b13c351d2f3da5a962d794fa1c8");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "User","ExerciseDay","Exercise","Measurement");
  }
